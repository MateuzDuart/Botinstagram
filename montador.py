...
class Botinstagram:
    ...
    def login(self):
        while True:
            cookies = []
            for _, _, item in os.walk('cookies'):
...
''')
    ...
    def limpar_atividade(self):
        ...
        while True:
            ...
            try:
                dados = self.navegador.find_element(By.XPATH,
                                                    f'/html/body/div[1]/section/main/div/article/div/div[2]/div[3]/div[{count}]/div/div/div[2]/div[2]/div/div/span[1]/div/time')
...
# ----------------------------- Ação ---------------------------------
botinstagram = Botinstagram()
botinstagram.login()
botinstagram.pop_up()
botinstagram.limpar_atividade()
